...
/**
 * Unit tests for DistributedSlidingWindowRateLimiter
 */
public class DistributedSlidingWindowTest {
    private DistributedSlidingWindowRateLimiter rateLimiter;
    ...
    public void setUp() {
        ...
        RateLimiter fallback = new SlidingWindowRateLimiter(config, new ClientRateLimitStore());
        rateLimiter = new DistributedSlidingWindowRateLimiter(config, store, fallback);
    }

    @Test
    public void testBasicRateLimit() {
        String clientId = "dist-sw-client-1";
    ...
    public void testRemainingRequests() {
        String clientId = "dist-sw-client-2";
    ...
    @Test
    public void testWindowSlides() throws InterruptedException {
        String clientId = "dist-sw-client-3";
